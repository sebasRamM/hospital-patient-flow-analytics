...
gold_dim_patient = "abfss://<<container>>@<<Storage_Acount_Name>>.dfs.core.windows.net/<<path>>"
gold_dim_department = "abfss://<<container>>@<<Storage_Acount_Name>>.dfs.core.windows.net/<<path>>"
gold_fact = "abfss://<<container>>@<<Storage_Acount_Name>>.dfs.core.windows.net/<<path>>"
